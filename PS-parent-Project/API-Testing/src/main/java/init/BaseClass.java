...
public class BaseClass {
    ...
    public RequestSpecification getReqSpecWithApiKey() {
        ...
        header.put("api-key", cr.get_api_key());
    ...
    // Method to get a RequestSpecification object with an API key and text/plain accept and content type
    public RequestSpecification getReqSpecWithApiKeyText() {
        // Creating a HashMap to hold the header information with the API key
        HashMap<String, String> header = new HashMap<>();
        header.put("api-key", cr.get_api_key());
        ...
        RequestSpecification reqSpec = new RequestSpecBuilder()
                .setBaseUri(cr.get_base_uri())
                .addHeaders(header)
                .setAccept(ContentType.TEXT) // Set accept header to text/plain
                .setContentType(ContentType.TEXT) // Set content type to text/plain
                .build();
        return reqSpec;
    }
